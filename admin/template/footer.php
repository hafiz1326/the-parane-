   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Tugas membuat web penjualan | 
              Dosen Pembimbing <a href="https://duamasachannel.blogspot.com" style="color:yellow;font-weight:700;" target="_blank">Siswan syaputra, M.KOM</a>
              <a href="#" class="go-top">
